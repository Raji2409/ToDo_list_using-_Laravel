...
<a href="<?php echo e(route('create.form')); ?>" class="btn btn-lg btn-warning">
Add New Task
</a><br><br>
</div>
...
<a href="<?php echo e(route('edit', $todo->id)); ?>" class="btn btn-outline-warning">
Edit
</a>

<a href="<?php echo e(route('delete', $todo->id)); ?>"
...
</html><?php /**PATH /config/workspace/Project/task_manager/resources/views/todos/index.blade.php ENDPATH**/ ?>